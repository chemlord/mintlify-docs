...
export const Banner = () => {
  return (
    <div className="flex not-prose bg-primary-dark" style={{ borderRadius: '0.5rem' }}>
      <div className="flex-1" style={{ padding: '1.5rem 2rem', }}>
      ...
      <div className="hidden sm:flex flex-1">
        <img src="https://chemlord.github.io/reactionrepo/article-repository/tribute-to-jcmartin/DMPOverviewDarkFix.png" />
      </div>
    </div>
  )
}