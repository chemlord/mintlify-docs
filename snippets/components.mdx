export const StartButton = ({ children = 'Go to Navigation' }) => {
  return (
...
export const HeroCard = ({ imgLight, imgDark, title, description, href }) => {
  return (
    <a
      className="border-b pb-8 cursor-pointer border-gray-500 dark:border-gray-800 hover:!border-primary dark:hover:!border-primary-light flex flex-col items-center text-center"
      href={href}
    >
...
export const Banner = () => {
  return (
    <div className="flex not-prose bg-primary-dark" style={{ borderRadius: '0.5rem' }}>
